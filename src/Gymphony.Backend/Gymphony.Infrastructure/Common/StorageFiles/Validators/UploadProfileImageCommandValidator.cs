...
{
    public UploadProfileImageCommandValidator(IOptions<StorageFileSettings> storageFileSettings)
    {
        ...
        {
                var validationSetings = GetStorageFileSettingsByFileType(StorageFileType.UserProfileImage, storageFileSettings.Value);
